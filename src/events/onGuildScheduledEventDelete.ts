...
import { Guild, GuildMember, GuildScheduledEvent, TextChannel } from "discord.js"
...
export default {
  ...
  async execute(client: BotClient, guildScheduledEvent: GuildScheduledEvent) {
    let guild = guildScheduledEvent.guild as Guild
    ...
    let logChannel = guild.channels.cache.get(
        ...
        },
        {
          ...
          value: guildScheduledEvent.scheduledStartAt
            ? DateFormatting.relative(
              guildScheduledEvent.scheduledStartTimestamp as number
            )
            : "없음",
        },
        {
          ...
          value: guildScheduledEvent.scheduledEndAt
            ? DateFormatting.relative(guildScheduledEvent.scheduledEndTimestamp as number)
            : "없음",
        },
        {
          name: "생성자",
